...
- (void)getCityInfo
{
    ...
    if (_isWeather) {
        ...
        if (_selectedItem == -1)
        {
            ...
            [[TuyaSmartSceneManager sharedInstance] getCityInfo:locationItem.latitude longitude:locationItem.longitude success:^(TuyaSmartCityModel *city) {
        ...
        else
        {
            ...
            [[TuyaSmartSceneManager sharedInstance] getCityInfoByCityId:_model.entityId success:^(TuyaSmartCityModel *city) {
                if (city.cityId > 0 && city.city.length > 0)
                {
                    weakSelf_AT.currentCity = city;
                    [weakSelf_AT.locationView setCity:city.city];
