...
- (void)initData {
    ...
    [[TuyaSmartSceneManager sharedInstance] getCityList:countryCode success:^(NSArray<TuyaSmartCityModel *> *list) {
        if (list.count == 0)
        {
            [[TuyaSmartSceneManager sharedInstance] getCityList:@"CN" success:^(NSArray<TuyaSmartCityModel *> *list) {
...
- (void)scheduledLocationManageDidUpdateLocations:(CLLocation *)location {
    ...
    WEAKSELF_AT
    [[TuyaSmartSceneManager sharedInstance] getCityInfo:[NSString stringWithFormat:@"%f",location.coordinate.latitude] longitude:[NSString stringWithFormat:@"%f",location.coordinate.longitude] success:^(TuyaSmartCityModel *city) {
...
- (void)mapView:(MKMapView *)mapView regionDidChangeAnimated:(BOOL)animated {
    ...
    WEAKSELF_AT
    [[TuyaSmartSceneManager sharedInstance] getCityInfo:[NSString stringWithFormat:@"%f",coord.latitude] longitude:[NSString stringWithFormat:@"%f",coord.longitude] success:^(id result) {
