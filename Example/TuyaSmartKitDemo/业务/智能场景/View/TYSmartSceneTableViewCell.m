...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _iconImageView = [[UIImageView alloc] initWithFrame:CGRectMake(15, 21, 48, 48)];
        _iconImageView.image = [UIImage imageNamed:@"ty_index_custom"];
        [self.contentView addSubview:_iconImageView];
        
        _titleLable = [TPViewUtil simpleLabel:CGRectMake(78, 33, APP_SCREEN_WIDTH - 78 - 10 - 80, 17) f:17 tc:HEXCOLOR(0x303030) t:@""];
...
- (void)setModel:(TuyaSmartSceneModel *)model {
    _model = model;
    [_iconImageView sd_setImageWithURL:[NSURL URLWithString:model.displayIcon] placeholderImage:[UIImage imageNamed:@"ty_index_custom"]];
